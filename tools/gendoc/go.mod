module github.com/iotaledger/inx-spammer/tools/gendoc

go 1.19

replace github.com/iotaledger/inx-spammer => ../../

require (
	github.com/iotaledger/hive.go/apputils v1.0.0-rc.1
	github.com/iotaledger/hive.go/core v1.0.0-rc.2
	github.com/iotaledger/inx-spammer v0.0.0-00010101000000-000000000000
)
